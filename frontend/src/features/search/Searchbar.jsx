            ...
            <form onSubmit={handleSearch} className="relative flex items-center w-full">
                <label className='w-full block'>
                    <input type="text"
                        ...
                        required //made input mandatory
                        className="w-full  rounded-full border border-slate-700 bg-slate-800/50 py-1.5 pl-4 pr-12 text-[0.8rem] sm:text-sm text-slate-200 placeholder-slate-400 focus:border-indigo-500 focus:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 transition-all duration-200"
                    />
                </label>
